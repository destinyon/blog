...
const BLOG = {
  ...
  KEYWORDS:
    ...
    'Celeste, Notion, 博客, 技术笔记, 项目记录, 课程学习', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'IT\'S WHY,NOT ZOMBIE🤫,GOOD MORNING,GOOD AFTERNOON,AND GOOD NIGHT💤,LIFE\'S NOT OUT TO GET YOU✊,WELCOME TO MY BLOG🎉',
